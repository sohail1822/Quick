  ...
  return !loading ? (
    <div className='flex-1 h-full flex flex-col gap-4 p-6'>
      ...
      <div className='bg-white h-full w-full rounded-xl overflow-y-scroll grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-4'>
        {creations.map((creation, index) => (
          <div key={index} className='relative group bg-white rounded-lg overflow-hidden'>
    ...
    (
      <div className='flex justify-center items-center h-full '>
        <span className='w-10 h-10 my-1 rounded-full border-3 border-primary border-t-transparent animated-spin'></span>
      </div>
    )
}
